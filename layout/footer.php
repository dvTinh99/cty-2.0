            ...
            <div class="row gx-5">
                <div class="col-lg-3 col-md-6 footer-about">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-4">
                        <a href="index.html" class="navbar-brand">
                            <img src="./img/cty/logo_white.png" alt="" style="width: 200px;height: 60px;">
                        </a>
                ...
                <div class="col-lg-3 col-md-12 pt-5 mb-5">
                    ...
                    <div class="d-flex mb-2">
                        ...
                        <p class="mb-0">ADMTECHNAMGROUP@GMAIL.COM</p>
                    </div>
                    <div class="d-flex mb-2">
                ...
                <div class="col-lg-2 col-md-12">
                    <div class="col-lg-12 col-md-12 pt-0 pt-lg-5 mb-5">
                        ...
                        <div class="link-animated d-flex flex-column justify-content-start">
                            ...
                            <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Dự án</a>
                            <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Cơ hội nghề nghiệp</a>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="col-lg-12 col-md-12 pt-0 pt-lg-5 mb-5">
                        <div id="fanpage">
                            <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FQuangcaodanentang&tabs=timeline&width=500&height=200&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=682695438819579" 
    ...
    <div class="hotline-phone-ring-wrap">
        ...
        <div class="hotline-bar">
            <a href="tel:0898982526"> <span class="text-hotline" style="font-size: 19px;">0588007777</span> </a>
        </div>
